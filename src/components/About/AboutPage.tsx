    ...
    <AboutContainer>
      <AboutMe>
        ...
        <AboutMeText>
          ...
          listen carefully and I love to explain things to people.
        </AboutMeText>
        <AboutMeText>
          I have always been interested in computers since my childhood. Doing
          something related to computers has always been in me and in 2022 I
          made a decision and stepped on this path.So far, I can say that I have
